...
enum class ConnectAssistUiState(
    ...
    @param:ColorRes val progressBackgroundTintColorResource: Int = R.color.progress_background_tint,
    val backButtonVisible: Boolean,
    val settingsButtonVisible: Boolean,
    val torConnectImageVisible: Boolean,
    @param:DrawableRes val torConnectImageResource: Int = R.drawable.connect,
    val titleLargeTextViewVisible: Boolean,
    @param:StringRes val titleLargeTextViewTextStringResource: Int = R.string.connection_assist_tor_connect_title,
    val titleDescriptionVisible: Boolean,
    @param:StringRes val learnMoreStringResource: Int? = null,
    @param:StringRes val internetErrorDescription: Int? = null,
    @param:StringRes val internetErrorDescription1: Int? = null,
    @param:StringRes val internetErrorDescription2: Int? = null,
    @param:StringRes val titleDescriptionTextStringResource: Int? = R.string.preferences_tor_network_settings_explanation,
    val quickstartSwitchVisible: Boolean,
    val regionDropDownVisible: Boolean,
    @param:StringRes val regionDropDownDefaultItem: Int = R.string.connection_assist_automatic_country_detection,
    val torBootstrapButton1Visible: Boolean,
    @param:StringRes val torBootstrapButton1TextStringResource: Int = R.string.tor_bootstrap_connect,
    ...
    @param:StringRes val torBootstrapButton2TextStringResource: Int? = R.string.connection_assist_configure_connection_button,
    ...
    RegionNotFound(
        ...
        quickstartSwitchVisible = false,
        regionDropDownVisible = true,
        regionDropDownDefaultItem = R.string.connection_assist_select_country_or_region,
        torBootstrapButton1Visible = true,
        torBootstrapButton1TextStringResource = R.string.connection_assist_try_a_bridge_button,
        torBootstrapButton1ShouldTryABridge = true,
        torBootstrapButton2Visible = false,
